...
#import "TGRNewUserViewController.h"

@interface TGRLoginViewController ()
<UITextFieldDelegate,
UIScrollViewDelegate,
TGRNewUserViewControllerDelegate>
...
@implementation TGRLoginViewController
...
- (void)presentNewUserViewController {
    TGRNewUserViewController *viewController = [[TGRNewUserViewController alloc] initWithNibName:nil bundle:nil];
...
- (void)setActivityViewVisible:(BOOL)visible {
    ...
    if (_activityViewVisible) {
        TGRActivityView *activityView = [[TGRActivityView alloc] initWithFrame:self.view.bounds];
