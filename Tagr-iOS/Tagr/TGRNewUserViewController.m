...
@interface TGRNewUserViewController () <UITextFieldDelegate, UIScrollViewDelegate>
...
@implementation TGRNewUserViewController
...
- (void)processFieldEntries {
    ...
    TGRActivityView *activityView = [[TGRActivityView alloc] initWithFrame:CGRectMake(0.f, 0.f, self.view.frame.size.width, self.view.frame.size.height)];
